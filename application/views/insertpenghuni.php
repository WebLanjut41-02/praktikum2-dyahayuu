...
<html lang="en">
  ...
  <body>
<center>N
<h1>Form Registrasi<br>Penghuni</h1></center>

<form action="<?=base_url().'index.php/penghuni/insert';?>" method="POST">
<div class="container">
<div class="row mt-3">
	<div class="col-md-12">
	...
	<div class="form-group">
	    ...
	    <input type="text"  name="ktp" class="form-control" id="nama" placeholder="Masukan Ktp">
	</div>
